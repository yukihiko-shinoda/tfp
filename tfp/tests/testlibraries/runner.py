...
if TYPE_CHECKING:
    ...
    from tfp.config import Project
...
class FileLock:
    ...
    async def __aenter__(self) -> None:
        ...
        # by other pytest-xdist worker processes (see tfp/cli.py's -n/--numprocesses), not by a coroutine
...
class Runner:
    ...
    def __init__(self, project: Project, environment: dict[str, str]) -> None:
        ...
        # (tfp/tests/test_plan.py) writes this environment's log file.
