...
TFP could always use more documentation, whether as part of the
official TFP docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `TFP` for local development.

1. Fork the `tfp` repo on GitHub.
2. Clone your fork locally:

   ```console
   git clone git@github.com:your_name_here/tfp.git
   ```
...
[GitHub Issues]: https://github.com/yukihiko-shinoda/tfp/issues
